...
/**
 * MENU DATA
 * Replace / expand these items using your real menu list.
 * category keys MUST match the chip data-filter values:
 * pav-bhaji, south-indian, sandwich, chinese, rice, beverages
 */
const MENU_ITEMS = [
  // ========= FRUIT SALAD =========
